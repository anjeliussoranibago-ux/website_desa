...
<body class="d-flex flex-column min-vh-100" style="background-color: #f4f7f9; padding-top: 76px;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-public fixed-top py-3">
        <div class="container">
            <a class="navbar-brand fw-bold d-flex align-items-center gap-2" href="portal.php" style="color: #0b214a; font-size: 1.3rem;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-center gap-3 mt-3 mt-lg-0">
                    <li class="nav-item"><a class="nav-link active fw-bold" href="portal.php"><i class="fa-solid fa-house me-1"></i> Beranda</a></li>
