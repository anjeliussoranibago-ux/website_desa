...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (strlen($nik) !== 16 || !ctype_digit($nik)) {
        ...
        try {
            ...
            $status = 'error';
            $pesan = ($e->getCode() == 23000) ? "Data NIK sudah terdaftar dalam sistem kami, silakan periksa kembali." : "Terjadi kesalahan sistem saat menyimpan data. Silakan coba lagi nanti.";
        }
    }
}
?>
            ...
            <div class="col-md-9 col-lg-10 d-flex flex-column" style="height: 100vh; overflow-x: hidden;">
                ...
                <div class="card shadow-sm glass-card border-0 mb-0 mt-0 flex-grow-1 d-flex flex-column" style="max-height: 100%; overflow: hidden; border-bottom-left-radius: 0 !important; border-bottom-right-radius: 0 !important;">
                    <div class="card-header bg-transparent border-bottom pt-3 px-4 pb-2">
                        <h5 class="fw-bold text-secondary mb-0"><i class="fa-solid fa-user-plus me-2"></i>Tambah Data Penduduk</h5>
                    </div>
                            ...
                            <div class="setting-block">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="nik" class="form-control" minlength="16" maxlength="16" pattern="\d{16}" title="Pastikan NIK sesuai dengan KTP (16 digit)" placeholder="Masukkan 16 digit NIK" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small fw-bold text-muted mb-1">Nomor Kartu Keluarga (KK) *</label>
                                        <input type="text" name="no_kk" class="form-control" minlength="16" maxlength="16" pattern="\d{16}" title="Pastikan No. KK sesuai (16 digit)" placeholder="Masukkan 16 digit No KK" oninput="this.value = this.value.replace(/[^0-9]/g, '')" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label small fw-bold text-muted mb-1">Nama Lengkap Sesuai KTP *</label>
                                        <input type="text" name="nama_lengkap" class="form-control" placeholder="Contoh: Tareweli Telaumbanua" required>
                                    </div>
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <div class="form-text">Format: JPG/PNG. Otomatis dikompres jika ukuran terlalu besar.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="setting-block">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="rt" class="form-control" placeholder="Contoh: 1 / 2 / 3">
